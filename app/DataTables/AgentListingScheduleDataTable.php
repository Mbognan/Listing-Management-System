    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
             ->addColumn('action', function($query){
                $edit = '<a href="'.route('user.listing-scedule.edit',$query->id).'" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>';
                $delete = '<a href="'.route('user.listing-scedule.destroy',$query->id).'" class="delete-item btn btn-sm btn-danger ml-4"><i class="fas fa-trash"></i></a>';
                return $edit.$delete;
            })

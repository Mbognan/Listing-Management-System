        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.listing-gallery.store') }}" method="POST"  enctype="multipart/form-data">
                            @csrf
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-primary" >All Images</h4>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img width="100px" height="80px" class="mt-2" src="{{ asset($image->image) }}" >
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.listing-gallery.destroy',$image->id) }}" class="btn btn-sm btn-danger delete-item"><i class="fas fa-trash"></i></a>
                                    </td>
                                  </tr>
                                @endforeach

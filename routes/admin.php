...
Route::group([
    ...
    Route::post('/listing-pending',[ PendingListingController::class, 'update'])->name('pending.update');
    /**ListingGallery */
    ...
    Route::get('/listing-scedule/{listing_id}', [ListingScheduleController::class, 'index'])->name('listing-scedule.index');
